...
<div class="faq-wrap">
  ...
  <div class="why-choose-us">
    <h2>Why Choose Us?</h2>
    <why-us :cardDetails="cardDetails"/>
...
.faq-wrap{
  ...
  .why-choose-us {
    @apply flex flex-col my-8 py-2 gap-8;
    ...
    @screen md {
      @apply my-24 gap-14 px-14;
    }

    h2{
      @apply  text-[25px] font-semibold leading-[normal];
